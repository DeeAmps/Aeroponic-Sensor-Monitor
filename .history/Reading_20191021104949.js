...
export default class Reading extends React.Component {
  ...
  getValuesFromApi = async () => {
    ...
    try {
      const apiUrl = `https://api.thingspeak.com/channels/871668/feeds.json?api_key=${READ_KEY}&results=1`;
        ...
        <Card>
          ...
          <Card.Content>
            <DataTable>
              ...
              <DataTable.Row>
                <DataTable.Cell style={{wordWrap: 'break-word'}}>
