...
export default class Reading extends React.Component {
  ...
  async regulate(type, action) {
    try {
      const apiUrl =
        'https://api.thingspeak.com/update.json?api_key=081YONFH751939R7';
      if (type === 'fan') {
        action === 'on'
          ? this.setState({fanOnSnackbar: true, fanOffSnackbar: false})
          : this.setState({fanOnSnackbar: false, fanOffSnackbar: true});
        const fanUpdate =
  ...
  render() {
    ...
    return this.state.loading ? (
      ...
      <>
        ...
        <Snackbar visible={this.state.fanSnackbar}>Turning on Fan</Snackbar>

        <Snackbar visible={this.state.pumpSnackbar}>
